...
/**
 * Calendar connections (Google, Microsoft, Apple). This was the calendar half
 * of the old IntegrationsView; the MCP, CLI and public-API cards that shared
 * that screen went with the cloud, and their i18n keys under
 * `integrations.{api,mcp,cli}` are unused.
 */
