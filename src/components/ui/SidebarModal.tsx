            ...
            <div ref={containerRef} className="flex h-[85vh]">
              ...
              >
                ...
                <nav
                  className={`relative flex-1 pb-2 overflow-y-auto ${
                    isCompact ? "px-1.5 pt-4" : "px-2.5 pt-4"
                  }`}
                >
                    ...
                    <div key={groupIndex} className={groupIndex > 0 ? "mt-6" : ""}>
                      {!isCompact && group.label && (
                        <div className="px-2 pb-1.5">
                          <span className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground/60 dark:text-muted-foreground/55">
                            {group.label}
                          </span>
                        </div>
                      )}
              ...
              <div className="flex-1 overflow-y-auto bg-background dark:bg-surface-1">
                <SettingsLayoutProvider value={{ isCompact }}>
                  <div className={isCompact ? "p-4" : "px-7 py-6"}>{children}</div>
